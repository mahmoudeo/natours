  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          url = type === 'password' ? 'http://127.0.0.1:8000/api/v1/changePassword' : 'http://127.0.0.1:8000/api/v1/updateMe';
          _context.n = 1;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          passwordCurrent = document.getElementById('password-current').value.toString();
          password = document.getElementById('password').value.toString();
          passwordConfirm = document.getElementById('password-confirm').value.toString();
          _context.n = 1;
